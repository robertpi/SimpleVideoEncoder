...
let website = "/SimpleVideoEncoder"

let githubLink = "https://github.com/robertpi/SimpleVideoEncoder"

// Specify more information about your project
let info =
  [ "project-name", "SimpleVideoEncoder"
    "project-author", "Robert Pickering"
    "project-summary", "Project has no summmary; update build.fsx"
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/SimpleVideoEncoder" ]
